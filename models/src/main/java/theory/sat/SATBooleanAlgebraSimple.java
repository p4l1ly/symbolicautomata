...
public class SATBooleanAlgebraSimple extends BooleanAlgebra<Integer, boolean[]> {
	...
	public SATBooleanAlgebraSimple(ISolver s, int universeSize) {
		if (universeSize < 0) {
	...
	public SATBooleanAlgebraSimple(int universeSize) {
	...
	public boolean HasModel(Integer p1, boolean[] el1, boolean[] el2) {
		throw new UnsupportedOperationException("SATBooleanAlgebraSimple.HasModel(_,_,_) is not implemented");
	}
	...
	public Pair<boolean[], boolean[]> generateWitnesses(Integer p) {
		throw new UnsupportedOperationException("SATBooleanAlgebraSimple.generateWitnesses is not implemented");
	}
